      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>shelldanlee@gmail.com</h5>
            <a href="mailto:shelldanlee@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
            <RiMessengerLine className='contact__option-icon'/>
            <h4>Messenger</h4>
            <h5>egatortutorials</h5>
            <a href="https://m.me/kaka.li.94009" target="_blank">Send a message</a>
          </article>
          <article className="contact__option">
